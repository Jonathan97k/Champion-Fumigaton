...
export default function BeeRemovalPage() {
  ...
  const process = [
    { icon: Search, title: 'Inspection', description: 'Locate the hive, identify the bee species, and assess the extent of the infestation and structural involvement.' },
    { icon: Target, title: 'Safe Removal', description: 'Use specialized techniques to carefully remove bees without harming them, preserving colonies when possible.' },
    { icon: SprayCan, title: 'Hive Extraction', description: 'Remove the hive structure, comb, and honey to prevent re-infestation and structural damage.' },
    { icon: ShieldCheck, title: 'Prevention', description: 'Seal entry points and apply preventive treatments to ensure bees do not return to the same location.' },
  ];
  ...
  const benefits = [
    ...
    'Family and pet safety guaranteed',
    'Entry point sealing included',
    'Emergency removal available 24/7',
  ];

  const relatedServices = [
    { title: 'Termite Proofing', href: '/services/termite-proofing', icon: Shield, desc: 'Professional termite control services' },
    { title: 'Rodent Control', href: '/services/rodent-control', icon: Award, desc: 'Rat and mouse elimination services' },
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[70vh] bg-[#0a0a0a] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1633537040100-94db76b4e5f5?w=1920&q=80" alt="Bee Removal" className="w-full h-full object-cover" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <span className="text-[#c9a84c]">Bee Removal</span>
            </nav>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 font-serif">Bee <span className="text-[#c9a84c]">Removal</span></h1>
            <p className="text-xl text-gray-300 mb-10 font-light leading-relaxed">Safe, humane bee and wasp removal services for homes and businesses in Malawi.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6 font-serif">What Is <span className="text-[#c9a84c]">Bee Removal</span>?</h2>
              <p className="text-gray-400 font-light leading-relaxed mb-6">Bee removal is the safe and humane extraction of bee colonies, hives, and swarms from residential and commercial properties. We use specialized techniques to remove bees without harming them, preserving these vital pollinators.</p>
              <p className="text-gray-400 font-light leading-relaxed">Our trained technicians handle everything from small swarms to established colonies nesting in walls, roofs, and other structures, ensuring complete removal and prevention of future infestations.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
              <div className="bg-[#161b22] border border-white/10 rounded-xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1633537040100-94db76b4e5f5?w=800&q=80" alt="Bee removal" className="w-full aspect-video object-cover" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-4 font-serif">The <span className="text-[#c9a84c]">Risks</span> of Ignoring Bees</h2>
          </div>
      ...
      <section className="py-20 bg-[#111418]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-4 font-serif">How We <span className="text-[#c9a84c]">Remove</span></h2>
          </div>
      ...
      <section className="py-20 bg-[#111418] relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-400 mb-10 font-light">Contact us now for a no-obligation inspection and quote. Safe, humane bee removal guaranteed.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/265991380581?text=Hello%20Champion%20Fumigation%2C%20I%20need%20Bee%20Removal%20services." target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#20bd5a] transition-all duration-300">Chat on WhatsApp</a>
