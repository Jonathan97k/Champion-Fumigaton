...
import { Shield, SprayCan, Search, Target, ShieldCheck, CheckCircle, ArrowRight, Phone, AlertTriangle, Droplets, Building2, Heart, Award, Star, Sparkles, HandSparkles, Wind, ClipboardCheck } from 'lucide-react';
import Link from 'next/link';

export default function HygieneSolutionsPage() {
  const risks = [
    { icon: Droplets, title: 'Disease Transmission', description: 'Unsanitary environments become breeding grounds for pathogens that spread illness among staff and customers.' },
    { icon: AlertTriangle, title: 'Regulatory Non-Compliance', description: 'Failure to meet health and hygiene standards leads to fines, legal action, and forced closure of your business.' },
    { icon: Building2, title: 'Customer Loss', description: 'Poor hygiene drives customers away and generates negative reviews that permanently damage your reputation.' },
  ];

  const process = [
    { icon: Search, title: 'Hygiene Audit', description: 'Comprehensive assessment of your facility to identify hygiene risks, problem areas, and improvement opportunities.' },
    { icon: Target, title: 'Custom Protocol', description: 'Develop a tailored hygiene and sanitation protocol specific to your business type, size, and compliance needs.' },
    { icon: SprayCan, title: 'Sanitization', description: 'Apply professional-grade sanitizers and disinfectants using advanced equipment for complete pathogen elimination.' },
    { icon: ClipboardCheck, title: 'Ongoing Support', description: 'Regular scheduled treatments and re-audits to maintain hygiene standards and provide compliance documentation.' },
  ];

  const benefits = [
    'Healthier environment for staff and customers',
    'Full compliance with health regulations',
    'Professional-grade disinfectants and equipment',
    'Reduced absenteeism from illness',
    'Enhanced business reputation and trust',
    'Custom schedules for your business needs',
  ];
  ...
  const relatedServices = [
    ...
    { title: 'Termite Proofing', href: '/services/termite-proofing', icon: Shield, desc: 'Professional termite control services' },
  ];
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[70vh] bg-[#0a0a0a] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1920&q=80" alt="Hygiene Solutions" className="w-full h-full object-cover" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <span className="text-[#c9a84c]">Hygiene Solutions</span>
            </nav>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 font-serif">Hygiene <span className="text-[#c9a84c]">Solutions</span></h1>
            <p className="text-xl text-gray-300 mb-10 font-light leading-relaxed">Professional sanitation and disinfection services for commercial kitchens, clinics, schools, and public spaces.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6 font-serif">What Are <span className="text-[#c9a84c]">Hygiene Solutions</span>?</h2>
              <p className="text-gray-400 font-light leading-relaxed mb-6">Our hygiene solutions provide professional deep cleaning, sanitization, and disinfection services for commercial and institutional facilities. We use hospital-grade disinfectants and advanced application methods to eliminate pathogens.</p>
              <p className="text-gray-400 font-light leading-relaxed">From restaurant kitchens to medical clinics, we help businesses maintain the highest standards of cleanliness and comply with health regulations through regular, documented treatment programs.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
              <div className="bg-[#161b22] border border-white/10 rounded-xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80" alt="Hygiene solutions" className="w-full aspect-video object-cover" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-4 font-serif">The <span className="text-[#c9a84c]">Risks</span> of Poor Hygiene</h2>
          </div>
      ...
      <section className="py-20 bg-[#111418]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-4 font-serif">How We <span className="text-[#c9a84c]">Sanitize</span></h2>
          </div>
