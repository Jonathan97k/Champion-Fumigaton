...
import { Shield, SprayCan, Search, Target, ShieldCheck, CheckCircle, ArrowRight, Phone, AlertTriangle, Factory, Cog, Building2, Award, Heart, Star, Zap, HardHat } from 'lucide-react';
import Link from 'next/link';

export default function IndustrialSprayingPage() {
  const risks = [
    { icon: Factory, title: 'Production Downtime', description: 'Pest infestations in industrial facilities force shutdowns, costing thousands in lost production and revenue.' },
    { icon: AlertTriangle, title: 'Regulatory Fines', description: 'Health and safety violations from pest problems can result in heavy fines and forced closures by regulators.' },
    { icon: Building2, title: 'Reputation Damage', description: 'Pest sightings in commercial facilities destroy customer trust and brand reputation that took years to build.' },
  ];

  const process = [
    { icon: Search, title: 'Facility Audit', description: 'Comprehensive inspection of your entire facility to identify pest entry points, harborage areas, and risk zones.' },
    { icon: Target, title: 'Custom Plan', description: 'Develop a site-specific treatment strategy considering your industry, operations, and compliance requirements.' },
    { icon: SprayCan, title: 'Treatment', description: 'Apply industrial-grade treatments using specialized equipment designed for large-scale commercial facilities.' },
    { icon: ShieldCheck, title: 'IPM Monitoring', description: 'Implement ongoing integrated pest management with regular monitoring and reporting for compliance.' },
  ];
  ...
  const benefits = [
    ...
    'Specialized industrial-grade equipment',
  ...
  const relatedServices = [
    ...
    { title: 'Indoor Residual Spraying', href: '/services/indoor-residual-spraying', icon: Award, desc: 'IRS for mosquito and vector control' },
  ];
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[70vh] bg-[#0a0a0a] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1920&q=80" alt="Industrial Spraying" className="w-full h-full object-cover" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <span className="text-[#c9a84c]">Industrial Spraying</span>
            </nav>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 font-serif">Industrial <span className="text-[#c9a84c]">Spraying</span></h1>
            <p className="text-xl text-gray-300 mb-10 font-light leading-relaxed">Large scale pest management solutions for factories, warehouses, processing plants, and commercial facilities.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6 font-serif">What Is <span className="text-[#c9a84c]">Industrial Spraying</span>?</h2>
              <p className="text-gray-400 font-light leading-relaxed mb-6">Industrial spraying involves the application of pest control treatments in large-scale commercial and industrial environments. Our methods are designed to handle the unique challenges of factories, warehouses, food processing plants, and commercial buildings.</p>
              <p className="text-gray-400 font-light leading-relaxed">We use high-capacity equipment and industrial-grade formulations that provide effective control while minimizing disruption to your operations and maintaining compliance with industry regulations.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
              <div className="bg-[#161b22] border border-white/10 rounded-xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=800&q=80" alt="Industrial spraying" className="w-full aspect-video object-cover" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#111418] relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-400 mb-10 font-light">Contact us now for a no-obligation inspection and quote. Protect your facility today.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/265991380581?text=Hello%20Champion%20Fumigation%2C%20I%20need%20Industrial%20Spraying%20services." target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#20bd5a] transition-all duration-300">Chat on WhatsApp</a>
